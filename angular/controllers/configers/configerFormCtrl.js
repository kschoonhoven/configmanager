configmanagerControllers.controller('ConfigerFormCtrl', ['$scope', 'Address', 'PropertyType', 'AdminPartnerService', 'User',
	function($scope, Address, PropertyType, AdminPartnerService, User) {
		...
		*/
		...
		$scope.submitForm = function() {
			...
			$scope.$emit('configer.save', data);
		};
		$scope.cancelForm = function() {
			$scope.$emit('configer.cancelForm');
		};
	}]);