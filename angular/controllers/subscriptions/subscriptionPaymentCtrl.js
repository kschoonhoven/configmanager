configmanagerControllers.controller('SubscriptionPaymentCtrl', ['$scope', '$routeParams', 'Subscription', 'Coupon', 'Plan',
			...
			Subscription.save(action, $scope.subscription, $scope.cc, $scope.coupon.value)
				.success(function(result) {
					...
					$scope.status.completeMsg = $scope.isUpgrade ? 
						'The subscription on your configer has been upgraded.' :
