...
angular.module('ConfigerInc.App', [
	'ngRoute',
	'ngCookies',
	'ngSanitize',
	'ui.bootstrap',
...
.run(['$state', function($state) {
    $state.go('home-signed-in.configers');
}]);