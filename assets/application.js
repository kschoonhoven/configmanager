...
configmanagerApp.config(['$routeProvider',
	function($routeProvider){
		$routeProvider
			...
			.when('/configers', {
				templateUrl: '/views/configers/configers.html',
				controller: 'ConfigersCtrl'
			})
			.when('/configers/new', {
				templateUrl: '/views/configers/new.html',
				controller: 'ConfigersCtrl'
			})
			.when('/configers/:configerId/edit', {
				templateUrl: '/views/configers/edit.html',
				controller: 'ConfigersCtrl'
			})
			.when('/configers/:configerId', {
				templateUrl: '/views/configers/configer.html',
				controller: 'ConfigerCtrl'
			})
			.when('/configers/:configerId/structures', {
				templateUrl: '/views/structures/index.html'
			})
			.when('/configers/:configerId/areas', {
				templateUrl: '/views/areas/index.html'
			})
			.when('/configers/:configerId/maintenance_items', {
			...
			.when('/configers/:configerId/projects', {
				templateUrl: '/views//projects/index.html'
			})
			.when('/configers/:configerId/configer_contractors', {
				templateUrl: '/views/configer_contractors/index.html'
			})
			.when('/configers/:configerId/appliances', {
				templateUrl: '/views/appliances/index.html'
			})
			.when('/configers/:configerId/finishes', {
				templateUrl: '/views/finishes/index.html'
			})
			.when('/configers/:configerId/paints', {
				templateUrl: '/views/paints/index.html'
			})
			.when('/configers/:configerId/inventory_items', {
...
var configmanagerControllers = angular.module('configmanagerControllers',[]);

/*
 * Controller for the main application
 */
configmanagerControllers.controller('AppCtrl', ['$scope', '$location', '$cookieStore',
...
$(document).ready(function() {
	...
	initUploader = function(itemid, type){
		...
		var uploader = new plupload.Uploader({
			...
			multipart: true,
	    	multipart_params:{
		      'key': gon.user + '/' + gon.configer + '/' + gon.controller + '/' + itemid + '/' + type + '/${filename}',
		      'Filename': '${filename}', 
		      'acl': gon.acl,
